                    ...
                    <div class="table-responsive">
                        <table id="example3" class="display min-w850 table-responsive">
                            ...
                            <tbody>
                                ...
                                <?php
                                $count = "1";
                                $query = "SELECT tbl_products.*, tbl_categories.cat_name,tbl_sub_category.sub_cat_name FROM `tbl_products`,`tbl_categories`,tbl_sub_category WHERE tbl_categories.cat_id=tbl_products.category and tbl_sub_category.sub_cat_id =tbl_products.sub_category and tbl_products.vendor_id ='$Vendor_ID' ";
            ...
            <form action="product_save.php" id="updatepro" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group"><label>Sub Category Name</label>
                                <select name="upd_sub_cat_name" id="upd_sub_cat_name" class="form-control" required>
                                    <option>Select Sub Categories</option>
                                </select>
                            </div>
                        </div>
