                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    <? //php
                                    // $q = "SELECT * FROM `tbl_vendor` WHERE `status` = 'Suspend'";
                                    // $k = mysqli_query($con, $q);
                                    // $r = mysqli_num_rows($k);
                                    ?>
                                    <span class="badge light text-white bg-primary rounded-circle"><? //php echo $r
                                                                                                    ?></span>
                                </a>
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
                                        <ul class="timeline">
                                            <? //php
                                            // $query = "SELECT * FROM `tbl_vendor` WHERE `status` = 'Suspend' ORDER BY id DESC LIMIT 6";
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1"><? //php echo $row['name']
                                                                            ?></h6>
                                                        <small class="d-block"><? //php echo $row['status']
                                                                                ?></small>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="backassets/images/drivers/<?= $userinfo['image'] ?>" width="20" alt="" />
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="vehicle.php">
                            <i class="flaticon-381-notepad"></i>
                            <span class="nav-text">Add Vehicles</span>
                        </a>
                    </li>
                    </br>
                    <li><a href="profile.php">
                            <i class="flaticon-381-notepad"></i>
                            <span class="nav-text">Profile Information</span>
                        </a>
                    </li>
