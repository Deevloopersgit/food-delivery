        ...
        <div class="row">
        	<div class="col-lg-6">
                ...
                <form method="post" class="row">
                    ...
                    <div class="form-group create-account col-md-12">
                    ...
                    <div class="table-responsive order_table">
                        <table class="table">
                            ...
                            <tbody class="view-cart";> 
                                ...
                                <!-- <tr> 
                                    <td>Berry Salad <span class="product-qty">x 3</span></td>
                                    <td>$204.00</td>
                                </tr> -->
                            </tbody>
...
function displayCart() {
  ...
  for(var i in cartArray) {
    output += "&nbsp;<tr>"
      ...
      + "<input type='number' readonly  class='item-count form-control ' data-name='" + cartArray[i].name + "' value='" + cartArray[i].count + "' style='width: 88px;height: 34px;height: 27px; background-color: white;'></div></td>"
      + "<td>$" + cartArray[i].total + "</td>" 
      +  "</tr> ";
  }
  $('.view-cart').html(output);
