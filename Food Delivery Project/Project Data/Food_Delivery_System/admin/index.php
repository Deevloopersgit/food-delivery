								...
								<div class="card trending-menus">
									...
									<div class="card-body">
										<div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
											...
											<img src="backassets/images/menus/9.png" alt="" width="60" class="rounded">
										</div>
										<div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
											...
											<img src="backassets/images/menus/10.png" alt="" width="60" class="rounded">
										</div>
										<div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
											...
											<img src="backassets/images/menus/11.png" alt="" width="60" class="rounded">
										</div>
										<div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">
											...
											<img src="backassets/images/menus/12.png" alt="" width="60" class="rounded">
										</div>
