...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO `tbl_products`(`category`,`sub_category`,`product_name`,`product_price`,`product_image`,`qauntity`,`descp`,`status`) VALUES ('$category','$subcategory','$pname','$pprice','$pimage','$quantity','$desc','Suspend')";
