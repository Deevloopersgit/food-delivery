...
<title>Deevloopers | <?=$pagename?></title>
<!-- Favicon icon -->
<link rel="icon" type="image/png" sizes="16x16" href="backassets/images/icon.png">
<link rel="stylesheet" href="backassets/vendor/chartist/css/chartist.min.css">
<!-- <link rel="stylesheet" href="backassets/vendor/global/global.min.js"> -->
<link href="backassets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
<link href="backassets/css/style.css" rel="stylesheet">
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&amp;family=Roboto:wght@100;300;400;500;700;900&amp;display=swap" rel="stylesheet">
<!-- fancy bpx cdn -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css" />
<!-- Datatable -->
<link href="backassets/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
<!-- Custom Stylesheet -->
<link href="backassets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
<link href="backassets/css/style.css" rel="stylesheet">
<script src="backassets/vendor/global/global.min.js"></script>
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&amp;family=Roboto:wght@100;300;400;500;700;900&amp;display=swap" rel="stylesheet">
<script src="https://cdn.ckeditor.com/4.16.0/standard/ckeditor.js"></script>
<link rel="stylesheet" href="backassets/css/countdown.min.css">
<script src="backassets/js/countdown.min.js"></script>
</head>
<body>
...
<img class="logo-abbr" src="backassets/images/icon.png" alt="">
<img class="logo-compact" src="backassets/images/b.png" alt="" style="max-width: 74px; margin-left: -1px;">
<img class="brand-title" src="backassets/images/b.png" alt="" style="max-width: 74px; margin-left: -1px;">
</a>
...
<div class="img_cont">
<img src="backassets/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
...
<div class="d-flex bd-highlight">
<div class="img_cont">
<img src="backassets/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
...
<div class="d-flex bd-highlight">
<div class="img_cont">
<img src="backassets/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
<span class="online_icon"></span>
</div>
<div class="user_info">
...
<div class="d-flex bd-highlight">
<div class="img_cont">
<img src="backassets/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
<span class="online_icon offline"></span>
</div>
<div class="user_info">
...
<div class="d-flex bd-highlight">
<div class="img_cont">
<img src="backassets/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
<span class="online_icon offline"></span>
</div>
<div class="user_info">
...
<img src="backassets/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
</div>
...
<div class="img_cont_msg">
<img src="backassets/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
</div>
</div>
<div class="d-flex justify-content-start mb-4">
<div class="img_cont_msg">
...
<?php
$q = "SELECT * FROM `tbl_user` WHERE `status` = 'Suspend' AND `role`='2'";
$k = mysqli_query($con, $q);
$r = mysqli_num_rows($k);
?>
<span class="badge light text-white bg-primary rounded-circle"><?php echo $r?></span>
</a>
<div class="dropdown-menu rounded dropdown-menu-right">
<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
<ul class="timeline">
<?php
$query = "SELECT * FROM `tbl_user` WHERE `status` = 'Suspend' AND `role`='2' ORDER BY id DESC LIMIT 6";
...
<img alt="image" width="50" src="backassets/images/vendors/<?php echo $row['image']?>">
</div>
<div class="media-body">
<h6 class="mb-1"><?php echo $row['name']?></h6>
<small class="d-block"><?php echo $row['status']?></small>
...
<a class="all-notification" href="vendor.php">See all notifications <i class="ti-arrow-right"></i></a>
</div>
</li>
<li class="nav-item dropdown notification_dropdown">
...
<img src="backassets/images/icon.png" width="20" alt=""/>
<div class="header-info">
<span class="text-black"><strong><?=$userinfo['name']?></strong></span>
<p class="fs-12 mb-0"><?=$userinfo['email']?></p>
</div>
</a>
...
<ul aria-expanded="false">
<li><a href="product_category.php">Product Category</a></li>
...
<li><a href="vendor.php">Add Vendors</a></li>
<li><a href="agent.php">Add Agents</a></li>
<li><a href="branch.php">Add Branches</a></li>
<li><a href="subscription.php">Add Subscription</a></li>
<li><a href="order.php">Add Orders</a></li>
<li><a href="uc-noui-slider.html">Noui Slider</a></li>
<li><a href="uc-sweetalert.html">Sweet Alert</a></li>
<li><a href="uc-toastr.html">Toastr</a></li>
<li><a href="map-jqvmap.html">Jqv Map</a></li>
...
<ul aria-expanded="false">
<li><a href="terms&conditions.php">Add Terms & Conditions</a></li>
...
<ul aria-expanded="false">
<li><a href="announcement.php">Add Announcements</a></li>
...
<li><a  href="agent.php">
<i class="flaticon-381-heart"></i>
<span class="nav-text">Add Agents</span>
</a>
</li>
<li><a  href="branch.php">
<i class="flaticon-381-heart"></i>
<span class="nav-text">Add Branches</span>
</a>
</li>

<li><a  href="subscription.php">
<i class="flaticon-381-heart"></i>
<span class="nav-text">Add Subscription</span>
</a>
</li>
<li><a  href="order.php">
<i class="flaticon-381-heart"></i>
<span class="nav-text">Add Orders</span>
</a>
</li>
...
<i class="flaticon-381-heart"></i>
<span class="nav-text">Add Packages</span>
</a>
</li>
<li><a  href="blog.php">
<i class="flaticon-381-heart"></i>
...
<img src="backassets/images/food-serving.png" alt="">
